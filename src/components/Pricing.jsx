...
const plans = [
  ...
  },
  {
    ...
    features: ['Unlimited lessons', 'All courses included', 'Quizzes', 'Leaderboard & leagues'],
    cta: 'Get Pro',
    variant: 'solid',
    featured: true,
  },
  {
    ...
    features: ['Everything in Pro', 'Unlimited AI Tutor', 'Role play scenarios', 'Stories — learn through fiction', 'Early access to courses'],
    cta: 'Get Pro+',
    variant: 'outline',
  },
]
